...
def get_grids(image_x_grid, image_y_grid, object_location):
    ...
    object_x_grid = np.where((image_x_grid>object_location[0]) & (image_x_grid<(object_location[0]+object_location[2])))
    object_y_grid = np.where((image_y_grid>object_location[1]) & (image_y_grid<(object_location[1]+object_location[3])))
